...
const Home = () => {
  ...
  const lottieOptions = {
    ...
    className: `w-full h-full transition-all duration-500 ${
      isHovering
        ? "scale-[130%] sm:scale-[140%] md:scale-[145%] lg:scale-[150%] rotate-2"
        : "scale-[125%] sm:scale-[135%] md:scale-[140%] lg:scale-[145%]"
    }`,
  };
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-full md:justify-between gap-10">
            {/* Left */}
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left" data-aos="fade-right" data-aos-delay="200">
              <StatusBadge />
              <MainTitle />
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full" data-aos="fade-up" data-aos-delay="1400">
                <CTAButton href="#Portfolio" text="Projects" icon={ExternalLink} />
                <CTAButton href="#Contact" text="Contact" icon={Mail} />
              </div>
              <div className="flex flex-wrap gap-4 mt-4" data-aos="fade-up" data-aos-delay="1600">
            ...
            {/* Right */}
            <div className="w-full max-w-[500px] py-10 lg:py-0 lg:w-1/2 relative flex items-center justify-center" onMouseEnter={() => setIsHovering(true)} onMouseLeave={() => setIsHovering(false)} data-aos="fade-left" data-aos-delay="600">
